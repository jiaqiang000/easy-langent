...
> 全称：
> 
> > **LangChain Expression Language（LangChain 表达式语言）**
> 
> 实际交流里更常见的说法是：
> 
> - **LCEL**
...
##### 实操案例中的效果验证
[[chapter4#4.4.6 RAG系统常见问题与优化方向]]
[[chapter4#4.5.3 调优方向：分割策略、向量模型、检索参数优化]]
基于结果，总结参数选择建议：
